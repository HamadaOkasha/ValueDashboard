    ...
    var table = $('.table').DataTable(
        {
            ...
            "buttons": [
                {
                    "extend": 'excelHtml5', "title": Resources.SharedResource.MessageTemplate, "text": '<span>' + Resources.SharedResource.exportexcel + ' <i class="icon-file-excel"></i></span>', "className": 'dt-button buttons-print btn btn-light', "exportOptions":
                    {
                        "columns": ':visible'
                    }
                },
            ...
            "ajax":
            {
                "url": "/MessageTemplate/LoadData?Search=" + $("#Title").val(),
                "type": "Post",
                "dataType": "JSON",
            },
            "columns": [
                { "data": "Title" },
                {
                    ...
                    "mRender": function (o) {
                        return '<div class="list-icons">'
                            + '<a href="/MessageTemplate/AddEdit/' + o.Id + '" class="list-icons-item text-primary-600" data-popup="tooltip" title="' + Resources.SharedResource.Edit + '"><i class="icon-pencil"></i></a> &nbsp;'
...
//    $.post('/MessageTemplate/Status?id=' + id + "&status=" + Status , function (response) {
//        if (response == true) {
