    ...
    var table = $('.table').DataTable(
        {
            ...
            "buttons": [
                {
                    "extend": 'excelHtml5', "title": Resources.SharedResource.AlrowadData, "text": '<span>' + Resources.SharedResource.exportexcel + ' <i class="icon-file-excel"></i></span>', "className": 'dt-button buttons-print btn btn-light', "exportOptions":
                    {
                        "columns": ':visible'
                    }
                },
            ...
            "ajax":
            {
                "url": "/AlrowadData/LoadData?Search=" + $("#Name").val()
            ...
            "columns": [
                ...
                { "data": "OrganizationId" },
                { "data": "ValueId" },
                { "data": "ResearchValueId" },
                { "data": "AlrowadVersionId" },
                ...
                },
                {
                    ...
                    "mRender": function (o) {
                        ...
                        return '<div class="list-icons">'
                            + '<a href="/AlrowadData/AddEdit/' + o.Id + '" class="list-icons-item text-primary-600" data-popup="tooltip" title="' + Resources.SharedResource.edit + '"><i class="icon-pencil"></i></a> &nbsp;'
...
function Status(id, Status) {
    $.post('/AlrowadData/Status?id=' + id + "&status=" + Status, function (response) {
        if (response == true) {
            swal({ title: '', text: Resources.SharedResource.ok, type: "success", confirmButtonText: Resources.SharedResource.ok, timer: 1000 }, function () {
                RefreshTable();
            });
        }
        else {
