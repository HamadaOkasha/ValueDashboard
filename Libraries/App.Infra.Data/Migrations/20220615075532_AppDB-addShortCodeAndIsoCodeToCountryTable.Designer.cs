...
namespace App.Infra.Data.Migrations
{
    ...
    [Migration("20220615075532_AppDB-addShortCodeAndIsoCodeToCountryTable")]
    partial class AppDBaddShortCodeAndIsoCodeToCountryTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Domain.Model.AlrowadData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("AlrowadVersionId")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ResearchValueId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ResearchValueId");

                    b.HasIndex("SectorId");

                    b.HasIndex("ValueId");

                    b.ToTable("AlrowadData");
                });

            modelBuilder.Entity("App.Domain.Model.AlrowadVersion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("App.Domain.Model.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("App.Domain.Model.Organization", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("App.Domain.Model.ResearchValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("App.Domain.Model.Sector", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("App.Domain.Model.Value", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("App.Domain.Model.AlrowadData", b =>
                {
                    b.HasOne("App.Domain.Model.AlrowadVersion", "AlrowadVersion")
                        .WithMany()
                        .HasForeignKey("AlrowadVersionId")
                    ...
                    b.HasOne("App.Domain.Model.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("App.Domain.Model.Organization", "Organization")
                        .WithMany()
                        .HasForeignKey("OrganizationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("App.Domain.Model.ResearchValue", "ResearchValue")
                        .WithMany()
                        .HasForeignKey("ResearchValueId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("App.Domain.Model.Sector", "Sector")
                        .WithMany()
                        .HasForeignKey("SectorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("App.Domain.Model.Value", "Value")
                        .WithMany()
                        .HasForeignKey("ValueId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AlrowadVersion");
