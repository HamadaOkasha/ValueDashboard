...
namespace App.Infra.Data.Repositories
{
    ...
    public class CategoryRepository : ICategoryRepository
    {
        ...
        public async Task<Tuple<IList<Category>, int>> LoadItemsData(string Search, int StatusId,  int jtStartIndex = 0,
            int jtPageSize = 10, string order = null, string orderDir = null, int languageId = 0)
        {
           var AllListCount = 0;
            ...
            return new Tuple<IList<Category>, int>(await result.Skip(jtStartIndex).Take(jtPageSize).ToListAsync(), AllListCount);
