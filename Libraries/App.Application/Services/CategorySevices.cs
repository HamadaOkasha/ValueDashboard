...
namespace App.Application.Services
{
    public class CategorySevices : ICategorySevices
    {
        ...
        public CategorySevices(ICategoryRepository CategoryRepository, IAttachmentService attachmentService,
             IMapper mapper
        ...
        public async Task<Tuple<IList<CategoryViewModel>, int>> LoadData(string Search = null, int StatusId = 0,
           int jtStartIndex = 0, int jtPageSize = 10, string order = null, string orderDir = null)
        {
            var data = await _CategoryRepository.LoadItemsData(Search, StatusId,
