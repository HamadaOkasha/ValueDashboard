...
namespace App.Admin.Controllers
{
    ...
    {
        private readonly IOrganizationSevices _OrganizationSevices;
        ...
        public OrganizationController(IOrganizationSevices OrganizationSevices,

            IInitalizeModelLookups initalizeModelLookups, ILocaleStringResourceSevices localeStringResourceSevices)
        {
            _OrganizationSevices = OrganizationSevices;
        ...
        {
            var model = await _OrganizationSevices.GetById(id);
            if (model == null)
            {
        ...
        [HttpPost]
        public async Task<IActionResult> AddEdit(OrganizationModel model)
        {
            await _OrganizationSevices.Save(model);
        ...
        {
            var result = await _OrganizationSevices.Delete(id);
            return Json(result);
        }
        [HttpPost]
        public async Task<IActionResult> Status(int id, bool status)
        {
            var result = await _OrganizationSevices.ChangeStatus(id, status);
            return Json(result);
        }
        ...
        public async Task<JsonResult> LoadData(string Search, int StatusId)
        {
            ...
            // int totalRecords;
            // Loading.
            var data = await _OrganizationSevices.LoadData(Search, StatusId,  startRec,
