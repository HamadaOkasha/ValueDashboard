    ...
    var table = $('.table').DataTable(
        {
            ...
            "buttons": [
                {
                    "extend": 'excelHtml5', "title": Resources.SharedResource.Country, "text": '<span>' + Resources.SharedResource.exportexcel + ' <i class="icon-file-excel"></i></span>', "className": 'dt-button buttons-print btn btn-light', "exportOptions":
                    {
                        "columns": ':visible'
                    }
                },
            ...
            "ajax":
            {
                "url": "/Country/LoadData?Search=" + $("#Name").val()
                ...
                },
                {
                    ...
                    "mRender": function (o) {
                        return '<div class="list-icons">'
                            + '<a href="/Country/AddEdit/' + o.Id + '" class="list-icons-item text-primary-600" data-popup="tooltip" title="' + Resources.SharedResource.edit + '"><i class="icon-pencil"></i></a> &nbsp;'
...
function Status(id, Status) {
    $.post('/Country/Status?id=' + id + "&status=" + Status, function (response) {
        if (response == true) {
